...
class RaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Race')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Race:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Race')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Race:edit.html.twig")
     */
