 ...
 *   https://datatables.net/download/#bs5/dt-1.13.8/fc-4.3.0/fh-3.4.0/kt-2.11.0
 *
 * Included libraries:
 *   DataTables 1.13.8, FixedColumns 4.3.0, FixedHeader 3.4.0, KeyTable 2.11.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.13.8/fc-4.3.0/fh-3.4.0/kt-2.11.0",
